...
static void call_deleteOperation_from_Tasklists(){
    ...
    std::unique_ptr<gtask::TaskListContainerIdArg> arg = gtask::TaskListContainerIdArg::EXAMPLE(0);
...
static void call_insert_from_Tasklists(){
    ...
    std::unique_ptr<tasklists::TaskListResource> arg = tasklists::TaskListResource::EXAMPLE(0);
...
static void call_list_from_Tasklists(){
    ...
    std::unique_ptr<gtask::TasklistsListArg> arg = gtask::TasklistsListArg::EXAMPLE(0);
...
static void call_update_from_Tasklists(){
    ...
    std::unique_ptr<gtask::TaskListContainerIdArg> arg = gtask::TaskListContainerIdArg::EXAMPLE(0);
    std::unique_ptr<tasklists::TaskListResource> arg2 = tasklists::TaskListResource::EXAMPLE(0);
...
static void call_clear_from_Tasks(){
    ...
    std::unique_ptr<gtask::TaskListClearArg> arg = gtask::TaskListClearArg::EXAMPLE(0);
...
static void call_deleteOperation_from_Tasks(){
    ...
    std::unique_ptr<gtask::TaskIdArg> arg = gtask::TaskIdArg::EXAMPLE(0);
...
static void call_insert_from_Tasks(){
    ...
    std::unique_ptr<gtask::TaskListIdArg> arg = gtask::TaskListIdArg::EXAMPLE(0);
    std::unique_ptr<tasks::TaskResource> arg2 = tasks::TaskResource::EXAMPLE(0);
...
static void call_list_from_Tasks(){
    ...
    std::unique_ptr<gtask::TaskListArg> arg = gtask::TaskListArg::EXAMPLE(0);
...
static void call_move_from_Tasks(){
    ...
    std::unique_ptr<gtask::TaskMoveArg> arg = gtask::TaskMoveArg::EXAMPLE(0);
