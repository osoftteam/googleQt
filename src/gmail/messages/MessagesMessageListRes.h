...
namespace messages{
    ...
    public:
        ...
        MessageListRes& setResultsizeestimate(const qint64& arg){m_resultSizeEstimate=arg;return *this;};
    ...
    public:
        ...
        static std::unique_ptr<MessageListRes> EXAMPLE(int context_index);
