...
namespace googleQt{
    ...
    public:
        ...
        std::unique_ptr<mail_batch::MessagesList> getCacheMessages(int numberOfMessages, uint64_t labelFilter = 0xFFFFFFFF);

        bool setStarred(mail_batch::MessageData* d, bool starred_on = true);
